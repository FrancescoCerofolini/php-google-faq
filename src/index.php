<?php
$menunav = ["Introduzione", "Norme sulla privacy", "Termini di servizio", "Tecnologie", "Domande frequenti"];
...
<head>
    ...
    <title>Google FAQ | 26-04-2021</title>
</head>
    ...
    <header>
        <div class="menunav">
            <div class="menunav-left">
                <img src="../dist/img/googlelogo.svg" alt="">
            ...
            <div class="navbar">
                ...
                <ul>
                    <?php for ($i = 0; $i < count($menunav); $i++) { ?><li> <?php echo $menunav[$i] ?> </li><?php } ?>
                </ul>

            </div>
            <div class="menunav-right">
                <img src="../dist/img/menu.svg" alt="">
    ...
    <main>
        ...
        $faqs = [
            ...
            [
                ...
                <p>Puoi leggere ulteriori informazioni sulla sicurezza online, incluso come proteggere te e la tua famiglia online, nel <span class=\"color-blue\">Centro Google per la sicurezza online.</span></p>
                <p><span class=\"color-blue\">Scopri </span>quali misure adottiamo per garantire protezione e sicurezza alle tue informazioni personali, lasciando a te il controllo.</p>",
            ],
            [
